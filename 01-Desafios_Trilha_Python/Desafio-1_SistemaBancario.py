...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print(f"\nVocê realizou {numero_saques} saques hoje.")
        print(f"Limite de {limite_saques} saques.")
    else:
        print("Operação falhou! O valor informado é inválido.")
    ...
    if contas == []:
        ...
        for conta in contas:
            ...
            lista_contas = f"""\
                ...
                Número da Conta:__{conta['numero_conta']}
                Titular:__________{conta['usuario']['nome']}
